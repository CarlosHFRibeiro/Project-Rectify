...
public class FrmTranspDetail extends javax.swing.JFrame {
    ...
    private void showDetail() {
        ...
        txtDtOf.setText(convertDateUtil(charge.getDtOfCharge()));
        txtHrOf.setText(String.valueOf(charge.getHrOfCharge()));
        txtNote.setText(String.valueOf(charge.getNoteCharge()));
        txtTicket.setText(String.valueOf(charge.getTicketCharge()));
        txtBoard.setText(charge.getBoardCharge());
        txtCnh.setText(charge.getDriver().getCnhDriver());
        txtDriver.setText(charge.getDriver().getNameDriver());
        txtDtUp.setText(convertDateUtil(charge.getDtUpCharge()));
        txtHrUp.setText(String.valueOf(charge.getHrUpCharge()));
        txtProduct.setText(charge.getProduct().getNameProduct());
        txtAcid.setText(String.valueOf(charge.getLabCar().getAcidCar()));
        txtSoap.setText(String.valueOf(charge.getLabCar().getSoapCar()));
        txtDens.setText(String.valueOf(charge.getLabCar().getDensityCar()));
        txtTrash.setText(String.valueOf(charge.getLabCar().getTrashCar()));
