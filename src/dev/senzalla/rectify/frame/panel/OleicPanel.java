 ...
 */
public class OleicPanel extends javax.swing.JPanel {
    ...
    public OleicPanel(String soap) {
        initComponents();
        TreatmentTheme.initTheme(pnlOleic);
        jComboBox1.setVisible(false);
        lblAcidity.setText(soap);
    }
    ...
    private void initComponents() {
        ...
        jlabelTitle.setText("ACIDEZ ÁCIDO GRAXO E BIODEISEL ESTEREFICADO");

        lblAcidity.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        lblAcidity.setText("Acidez");

        jlabelAcidity.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        jlabelAcidity.setText("% OLÉICO");
