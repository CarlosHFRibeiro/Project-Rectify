...
public class PnlReactTransDetail extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblEsterReactDt.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        lblEsterReactDt.setText("Data");

        dtcTrans.setDateFormatString("dd/MM/yyyy");

        lblEsterReactHrStart.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        ...
        lblTransReactMethylate.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        lblTransReactMethylate.setText("Metilato");

        cbxanalyzeTruck.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        cbxanalyzeTruck.setPreferredSize(new java.awt.Dimension(120, 27));

        lblEsterReactLabStart.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        lblEsterReactLabStart.setText("Cod Analise");

        lblTransReactPure.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        ...
        lblTransReactHrFinal.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        ...
        pnlReactLayout.setHorizontalGroup(
            ...
            .addGroup(pnlReactLayout.createSequentialGroup()
                ...
                .addGroup(pnlReactLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbxanalyzeTruck, 0, 130, Short.MAX_VALUE)
    ...
    public void saveReact() {
        ...
        reactTrans.setMethylateReactTrans(Integer.parseInt(txtTransReactMethylate.getText()));
        reactTrans.setPureReactTrans(Integer.parseInt(txtTransReactPure.getText()));
        reactTrans.setDateReactTrans(dtcTrans.getDate());
        reactTrans.setHourStartReactTrans(Time.valueOf(txtEsterReactHrStart.getText()));
        reactTrans.setHourFinalReactTrans(Time.valueOf(txtTransReactHrFinal.getText()));
        reactTrans.setLabTank((LabTank) cbxanalyzeTruck.getSelectedItem());
        new ReactTransRequest().insert(reactTrans);
    }
}
