...
public class FrmDcharge extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lblanalyzeTruck.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (TxtTreatment.isTextFieldEmpty(pnlCharge) && ComboBoxTreatment.isCbxEmpty(pnlCharge) && SpinnerTreatment.isSpinnerVoid(pnlCharge) && new DateChooserTreatment().isDateChooserNull(pnlCharge)) {
            ...
            Access.goToInternalFrame(this, new FrmDcharge());
        } else {
            PopUp.fieldIsEmpty();
        }
    ...
    private void btnClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearActionPerformed
        new ChargeTreatment().clear(pnlCharge);
    ...
    private void txtLitterFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtLitterFocusLost
        if (cbxanalyzeTruck.getSelectedIndex() > 0 && !txtLitter.getText().equals("")) {
            int litter = new ChargeTreatment().calcLitter(cbxanalyzeTruck.getSelectedItem(), Integer.parseInt((txtLitter.getText())));
    ...
    private void rollChargeMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_rollChargeMouseWheelMoved
        ItemTreatment.speedRoll(rollCharge);
