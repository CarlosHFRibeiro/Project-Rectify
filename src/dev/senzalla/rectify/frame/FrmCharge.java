...
public class FrmCharge extends javax.swing.JInternalFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if ( TreatmentTxt.isTxtEmpty(pnlCharge) &&  CbxTreatment.isCbxEmpty(pnlCharge) && new TreatmentSpn().isSpnVoid(pnlCharge) && new TreatmentDtc().isDtcVoid(pnlCharge)) {
            if (driverEmpty) {
                new TreatmentDriver().saveDriver(txtDriver, txtCnh);
                driver = new RequestDriver().selectCnh(txtCnh.getText());
            }
            new ChargeTreatment().saveChage(pnlCharge, cbxProvider.getSelectedItem(), dtcDtOf.getDate(), txtHrOf.getText(), spnNote.getValue(), spnTicket.getValue(), txtBoard.getText(), driver, dtcDtUp.getDate(), txtHrUp.getText(), cbxProduct.getSelectedItem(), cbxanalyzeTruck.getSelectedItem(), txtBurden.getText(), txtLitter.getText(), cbxTank.getSelectedItem());
        } else {
            EmptyField.showMsg();
        }
    ...
    private void txtBurdenFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtBurdenFocusLost
        ...
        if (cbxanalyzeTruck.getSelectedIndex() > 0 && !txtBurden.getText().equals("")) {
            int litter = new ChargeTreatment().calcLitter(cbxanalyzeTruck.getSelectedItem(), Integer.parseInt((txtBurden.getText())));
