...
public class DischargeDetailFrame extends javax.swing.JFrame {
    private Discharge discharge;

    /**
     * Creates new form FrmTranspDetail
     */
    public DischargeDetailFrame() {
        initComponents();
        TreatmentTheme.initTheme(pnlDetail);
    }

    public DischargeDetailFrame(Object cod) {
        initComponents();
        TreatmentTheme.initTheme(pnlDetail);
        Discharge d = new Discharge();
        d.setIdDcharge(Long.valueOf(cod.toString()));
        discharge = new DischargeRequest().select(d);
        showDetail();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DischargeDetailFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DischargeDetailFrame().setVisible(true);
            }
        });
    }
    ...
    private void showDetail() {
        ...
        txtDtOf.setText(convertDateUtil(discharge.getDateEntryDcharge()));
        txtHrOf.setText(String.valueOf(discharge.getTimeEntryDcharge()));
        txtNote.setText(String.valueOf(discharge.getNoteDcharge()));
        txtTicket.setText(String.valueOf(discharge.getTicketDcharge()));
        txtBoard.setText(discharge.getCarPlateDcharge());
        txtCnh.setText(discharge.getDriver().getCnhDriver());
        txtDriver.setText(discharge.getDriver().getNameDriver());
        txtDtUp.setText(convertDateUtil(discharge.getDateExitDcharge()));
        txtHrUp.setText(String.valueOf(discharge.getTimeExitDcharge()));
        txtProduct.setText(discharge.getProduct().getNameProduct());
        txtAcid.setText(String.valueOf(discharge.getanalyzeTruck().getAcidityAnalyzeTruck()));
        txtSoap.setText(String.valueOf(discharge.getanalyzeTruck().getSaponityAnalyzeTruck()));
        txtDens.setText(String.valueOf(discharge.getanalyzeTruck().getDensityAnalyzeTruck()));
        txtTrash.setText(String.valueOf(discharge.getanalyzeTruck().getTrashAnalyzeTruck()));
