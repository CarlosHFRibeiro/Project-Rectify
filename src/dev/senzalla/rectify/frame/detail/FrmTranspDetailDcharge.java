...
public class FrmTranspDetailDcharge extends javax.swing.JFrame {
    ...
    private void showDetail() {
        ...
        txtAcid.setText(String.valueOf(discharge.getanalyzeTruck().getAcidCar()));
        txtSoap.setText(String.valueOf(discharge.getanalyzeTruck().getSoapCar()));
        txtDens.setText(String.valueOf(discharge.getanalyzeTruck().getDensityCar()));
        txtTrash.setText(String.valueOf(discharge.getanalyzeTruck().getTrashCar()));
