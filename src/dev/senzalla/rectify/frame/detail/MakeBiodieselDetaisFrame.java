 ...
 */
public class MakeBiodieselDetaisFrame extends javax.swing.JFrame {

    private MakeBiodiesel makeBiodiesel;

    public MakeBiodieselDetaisFrame() {
    }
     ...
     * @param biodiesel
     */
    public MakeBiodieselDetaisFrame(MakeBiodiesel biodiesel) {
        initComponents();
        getMatter(biodiesel);
        initPanel();
        fillPanel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MakeBiodieselDetaisFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MakeBiodieselDetaisFrame().setVisible(true);
        });
    }
    ...
    private void getMatter(MakeBiodiesel biodiesel) {
        this.makeBiodiesel = new MakeBiodieselRequest().select(biodiesel);
    }
    ...
    private void addPanelMatter() {
        ...
        makeBiodiesel.getMatterMakes().forEach(matterEster -> {
