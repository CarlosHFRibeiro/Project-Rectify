...
import dev.senzalla.rectify.treatments.DateChooserTreatment;
 ...
 */
public class SampleFilterFrame extends javax.swing.JFrame {

    private final JTable table;

    /**
     * Creates new form FrmFilterSample
     *
     * @param table {@link JTable}
     */
    public SampleFilterFrame(JTable table) {
        initComponents();
        initPanel();
        this.table = table;
//        lblDataUntil.setVisible(true);
//        dtcDateUntil.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        lblAuction = new javax.swing.JLabel();
        cbxAuction = new javax.swing.JComboBox<>();
        ...
        lblDataUntil = new javax.swing.JLabel();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        if (!ComboBoxTreatment.isCbxEmpty(pnlSample) || DateChooserTreatment.isDateChooserFilterNull(pnlSample)) {
            Integer auctionNumber = cbxAuction.getSelectedIndex() > 0 ? Integer.valueOf(cbxAuction.getSelectedItem().toString()) : null;
            SampleTreatment.setTableFilters(table, auctionNumber, cbxProvider.getSelectedItem(), dtcDateOf.getDate(), dtcDateUntil.getDate());
            this.dispose();
        }
    }//GEN-LAST:event_btnSearchActionPerformed

    private void btnCleanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCleanActionPerformed
        SampleTreatment.initTable(table);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SampleFilterFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SampleFilterFrame(new JTable()).setVisible(true);
        });
    }
    ...
    private javax.swing.JComboBox<Object> cbxAuction;
    ...
    private javax.swing.JLabel lblAuction;
    private javax.swing.JLabel lblDataUntil;
    ...
    private void initPanel() {
        ...
        SampleTreatment.initComboBox(cbxAuction);
