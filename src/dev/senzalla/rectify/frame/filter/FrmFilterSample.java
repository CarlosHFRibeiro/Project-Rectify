 ...
 */
public class FrmFilterSample extends javax.swing.JFrame {
     ...
     */
    public FrmFilterSample(JTable table) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setName("FrmFilterSample"); // NOI18N
        setResizable(false);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        new TreatmentSeal().showTable(table, cbxSale, cbxProvider, dtcDe, dtcAte);
        this.dispose();
    }//GEN-LAST:event_btnSearchActionPerformed

    private void btnCleanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCleanActionPerformed
        new TreatmentSeal().showTable(table);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFilterSample.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmFilterSample(new JTable()).setVisible(true);
            }
        });
    }
