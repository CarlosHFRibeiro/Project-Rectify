...
public class TransportFilterFrame extends javax.swing.JFrame {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        if (isCharge) {
            ChargeTreatment.setTableFilters(tableTransport, (Long) spnIdTransport.getValue(), dtcDateOf.getDate(), dtcDateUntil.getDate(), (Integer) spnTicket.getValue(), (Integer) spnNote.getValue(), (Product) cbxProduct.getSelectedItem(), (Provider) cbxProvider.getSelectedItem());
        } else {
            DischargeTreatment.setTableFilters(tableTransport, (Long) spnIdTransport.getValue(), dtcDateOf.getDate(), dtcDateUntil.getDate(), (Integer) spnTicket.getValue(), (Integer) spnNote.getValue(), (Product) cbxProduct.getSelectedItem(), (Provider) cbxProvider.getSelectedItem());
        }
        this.dispose();
