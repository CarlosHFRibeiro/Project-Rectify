 ...
 */
public class FrmFilterMake extends javax.swing.JFrame {
    private JTable tbl;
     ...
     */
    public FrmFilterMake() {
        initComponents();
        TreatmentTheme.initTheme(pnlTransp);
    }

    public FrmFilterMake(JTable tbl, boolean isMakeEster) {
        this.tbl = tbl;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFilterMake.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmFilterMake().setVisible(true);
            }
        });
    }
