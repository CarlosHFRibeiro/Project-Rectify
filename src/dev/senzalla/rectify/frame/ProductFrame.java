...
public class ProductFrame extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lblDensity.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        lblDensity.setText("Densidade");

        txtDensity.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
    ...
    private void txtDensityKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDensityKeyTyped
        NumberField.addNumber(txtDensity.getText(), evt);
    }//GEN-LAST:event_txtDensityKeyTyped

    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (TxtTreatment.isTextFieldEmpty(pnlProduct)) {
            new ProductTreatment().saveProduct(txtName.getText(), txtDensity.getText());
            TxtTreatment.cleanTextField(pnlProduct);
        } else {
            PopUp.fieldIsEmpty();
        }
